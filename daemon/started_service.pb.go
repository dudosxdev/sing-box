...
const file_daemon_started_service_proto_rawDesc = "" +
	...
	"\x05items\x18\x06 \x03(\v2\x11.daemon.GroupItemR\x05items\"\xc1\x01\n" +
	"\tGroupItem\x12\x10\n" +
	"\x03tag\x18\x01 \x01(\tR\x03tag\x12\x12\n" +
	...
	"\furlTestError\x18\x06 \x01(\tR\furlTestError\"2\n" +
...
var file_daemon_started_service_proto_msgTypes = make([]protoimpl.MessageInfo, 38)
